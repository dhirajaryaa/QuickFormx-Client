            ...
            <div className="w-full max-w-sm">
                <div className="flex flex-col gap-6">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        {...register("email", {
                                            ...
                                            minLength: { value: 3, message: "Email must be more then 3 characters" },
                                            maxLength: { value: 60, message: "Email must no more then 60 characters" },
                                            pattern: {
                                                value: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
                    ...
                    <div className="text-balance text-center text-xs text-muted-foreground [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-primary  ">
                        By clicking continue, you agree to our <a href={link.termsOfService}>Terms of Service</a>{" "}
                        and <a href={link.privacyPolicy}>Privacy Policy</a>.
                    </div>
                </div>
            </div>
        </div>
